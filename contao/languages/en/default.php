...
// Messages generated by src\Controller\FrontendModule\EventBookingController.php controller
$GLOBALS['TL_LANG']['MSC'][EventBookingController::CASE_BOOKING_NOT_YET_POSSIBLE] = 'Booking is only possible from %s .';
$GLOBALS['TL_LANG']['MSC'][EventBookingController::CASE_BOOKING_NO_LONGER_POSSIBLE] = 'The registration period for this event has already expired. Registrations can no longer be accepted.';
$GLOBALS['TL_LANG']['MSC'][EventBookingController::CASE_EVENT_FULLY_BOOKED] = 'This event is fully booked.';
$GLOBALS['TL_LANG']['MSC'][EventBookingController::CASE_WAITING_LIST_POSSIBLE] = 'This event is fully booked. Subscription to the waiting list is possible.';
$GLOBALS['TL_LANG']['MSC'][EventBookingController::CASE_BOOKING_POSSIBLE] = 'Booking possible';
