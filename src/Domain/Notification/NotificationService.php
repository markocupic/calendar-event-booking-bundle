...
namespace Markocupic\CalendarEventBookingBundle\Domain\Notification;
...
{
    private const string PREFIX_MEMBER = 'member_';

    private const string PREFIX_CALENDAR = 'calendar_';

    private const string PREFIX_EVENT = 'event_';

    private const string PREFIX_ORGANIZER = 'organizer_';

    private const string PREFIX_ORDER = 'order_';

    private const string PREFIX_PAYMENT = 'payment_';
