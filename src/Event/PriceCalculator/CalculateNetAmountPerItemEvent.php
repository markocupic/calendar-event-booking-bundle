...
class CalculateNetAmountPerItemEvent extends Event
{
    ...
    public function getNetAmountPerItem(): float
    {
        return $this->netAmountPerItem;
    }

    public function setNetAmountPerItem(float $netAmountPerItem): void
    {
        $this->netAmountPerItem = $netAmountPerItem;
    }
}
