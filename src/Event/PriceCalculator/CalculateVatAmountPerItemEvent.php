...
class CalculateVatAmountPerItemEvent extends Event
{
    ...
    public function getVatAmountPerItem(): float
    {
        return $this->vatAmountPerItem;
    }

    public function setVatAmountPerItem(float $vatAmountPerItem): void
    {
