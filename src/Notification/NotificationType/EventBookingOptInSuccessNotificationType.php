...
class EventBookingOptInSuccessNotificationType implements NotificationTypeInterface, CalendarEventsBookingNotificationTypeInterface
{
    public const string NAME = 'event-booking-opt-in-success-notification';
