 ...
 *
 * With SEPA direct debit and friends the rejection arrives days after the
 * checkout, when the customer is long gone from the website. Without this
 * message they would keep believing the booking is settled.
 */
#[AutoconfigureTag('cebb.notification')]
class EventBookingPaymentFailedNotificationType implements NotificationTypeInterface, CalendarEventsBookingNotificationTypeInterface
{
    public const NAME = 'event-booking-payment-failed-notification';
