...
/**
 * Sent when a payment has been authorised but is not settled yet.
 *
 * Payment methods like SEPA direct debit, Klarna or Bacs complete the checkout
 * immediately and confirm the money days later. Without a message of its own the
 * customer is left in the dark: the success notification would be wrong, and no
 * notification at all looks like the booking never went through.
 */
#[AutoconfigureTag('cebb.notification')]
class EventBookingPaymentPendingNotificationType implements NotificationTypeInterface, CalendarEventsBookingNotificationTypeInterface
{
    public const NAME = 'event-booking-payment-pending-notification';
