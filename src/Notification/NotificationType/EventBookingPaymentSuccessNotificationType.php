...
class EventBookingPaymentSuccessNotificationType implements NotificationTypeInterface, CalendarEventsBookingNotificationTypeInterface
{
    public const string NAME = 'event-booking-payment-success-notification';
