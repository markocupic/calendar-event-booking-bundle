...
class WaitingListAdvancementNotificationType implements NotificationTypeInterface, CalendarEventsBookingNotificationTypeInterface
{
    public const string NAME = 'waiting-list-advancement-notification';
