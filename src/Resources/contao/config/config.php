...
$GLOBALS['NOTIFICATION_CENTER']['NOTIFICATION_TYPE']['calendar-event-booking-bundle'] = array(
	...
	'booking-notification'           => array(
		...
		'email_subject'        => array('event_*', 'event_title', 'event_unsubscribeLimitDate', 'event_unsubscribeLimitDatim', 'event_unsubscribeHref', 'member_*', 'member_dateOfBirthFormated', 'member_salutation', 'organizer_*', 'organizer_senderName', 'organizer_senderEmail'),
		'email_text'           => array('event_*', 'event_title', 'event_unsubscribeLimitDate', 'event_unsubscribeLimitDatim', 'event_unsubscribeHref', 'member_*', 'member_dateOfBirthFormated', 'member_salutation', 'organizer_*', 'organizer_senderName', 'organizer_senderEmail'),
		'email_html'           => array('event_*', 'event_title', 'event_unsubscribeLimitDate', 'event_unsubscribeLimitDatim', 'event_unsubscribeHref', 'member_*', 'member_dateOfBirthFormated', 'member_salutation', 'organizer_*', 'organizer_senderName', 'organizer_senderEmail'),
	),
	// Type
