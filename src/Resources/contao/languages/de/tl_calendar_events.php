...
$GLOBALS['TL_LANG']['tl_calendar_events']['event_unsubscribe_legend'] = "Event Abmelde-Einstellungen";
...
$GLOBALS['TL_LANG']['tl_calendar_events']['addBookingForm'] = ["Buchungsoptionen öffnen", 'Öffnen Sie die Buchungsoptionen.'];
...
$GLOBALS['TL_LANG']['tl_calendar_events']['emailFromName'] = ["E-Mail Absendernamen", "Geben Sie bitte den Absendernamen der Bestätigungs E-Mail ein."];
$GLOBALS['TL_LANG']['tl_calendar_events']['emailFrom'] = ["E-Mail Adresse des Absenders", "Geben Sie bitte die Absender E-Mail-Adresse an. An diese Adresse werden allfällige Rückfragen gesendet."];
$GLOBALS['TL_LANG']['tl_calendar_events']['bookingConfirmationEmailBody'] = ["E-Mail-Text für Anmeldebestätigung an Teilnehmer", "Personalisieren Sie die E-Mail mit Tags: ##firstname## ##eventname## ##gender## ##firstname## ##lastname## ##street## ##postal## ##city## ##phone## ##email## ##escorts##"];
$GLOBALS['TL_LANG']['tl_calendar_events']['minMembers'] = ["Minimale Teilnehmerzahl", "Geben Sie bitte eine Teilnehmerzahl ein."];
$GLOBALS['TL_LANG']['tl_calendar_events']['maxMembers'] = ["Maximale Teilnehmerzahl", "Geben Sie bitte eine Teilnehmerzahl ein."];
$GLOBALS['TL_LANG']['tl_calendar_events']['enableNotificationCenter'] = ['Notification Center für die Anmeldebestätigung nutzen', 'Notification Center zur Anmeldebstätigung nutzen.'];
