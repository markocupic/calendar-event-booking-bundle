...
$GLOBALS['TL_LANG']['tl_calendar_events']['activateNotification'] = ['Select message for booking confirmation', 'Select a message (Notification Center) for the booking confirmation.'];
